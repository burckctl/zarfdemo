...
info_pause_exec "deploy games to cluster" "zarf package deploy zarf-package-dos-games-amd64.tar.zst"

section "PLAY"
info_pause_exec "connect to game service" "zarf connect games"
